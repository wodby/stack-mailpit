# Mailpit stack for Wodby

Deploy Mailpit on Kubernetes with Wodby. This repository contains the stack
manifests used by the public Mailpit stack in the Wodby catalog.

- [Mailpit stack in the Wodby catalog](https://wodby.com/stacks/mailpit)
